...
import { getGenres, getVideogames, postVideogame, searchByName} from "../../actions";
import './CreateVideogame.css'

function validate(input, checkVideogame){
	let errors = {};
	if(!input.name){
...
export default function CreateVideogame(){
	...
	function handleSelect(e){
		const genreExist = input.genres.filter(el => el === e.target.value);
		...
		<div className="divTot">
			<form className="divAddAll" onSubmit={(e) => handleSubmit(e)}>
				...
				<div className="buttons">
					...
					{/* <button className="buttonReset" onClick={(e) => handleReset(e)}>Reset</button> */}
				</div>
			</form>
